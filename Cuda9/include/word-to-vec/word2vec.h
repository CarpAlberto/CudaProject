...
struct Word2Vec
{
	...
	struct Word
	{
		...
		Word(int32_t index, String text, uint32_t count, Word *left = 0, Word *right = 0) : 
	...
	Word2Vec(int size = 100, int window = 5, float sample = 0.001, int min_count = 1, int negative = 0, float alpha = 0.025, float min_alpha = 0.0001) 
